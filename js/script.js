...
monogatari.script ({
	...
	'English':{
		...
		'Introduction': [
			...
			'centered Apakah kamu tahu?...',
			'centered Pada awalnya dunia ini berada pada zaman kegelapan',
			'particles universe',
			'centered Namun suatu saat pasti akan ada cahaya',
			'stop particles',
			{'Function': {
				'Apply': function () {
			...
			'particles universe',
			'centered Cahaya kecil redup yang suatu saat akan menjadi petunjuk',
			'stop particles',
			{'Function': {
				'Apply': function () {
			...
			'particles universe',
			'centered Semakin lama semakin terang',
			'stop particles',
			{'Function': {
				'Apply': function () {
			...
			'particles universe',
			'centered Lalu dunia ini mulai masuk ke era baru',
			'centered Dunia indah yang bergemerlap cahaya',
			'stop particles',
			{'Function': {
				'Apply': function () {
			...
			'centered Cahaya tersebut membawa kita dari zaman jahiliyah ke zaman islamiah',
			'centered hehe',
			'stop particles',
